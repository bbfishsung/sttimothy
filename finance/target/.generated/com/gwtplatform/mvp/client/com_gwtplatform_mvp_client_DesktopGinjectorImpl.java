...
public class com_gwtplatform_mvp_client_DesktopGinjectorImpl implements com.gwtplatform.mvp.client.DesktopGinjector {
  ...
  public javax.inject.Provider<org.sttimothy.finance.client.application.ApplicationPresenter> getorgsttimothyfinanceclientapplicationApplicationPresenter() {
    return fieldcom_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector.getFragment_org_sttimothy_finance_client_application().get_Key$type$com$google$inject$Provider$org$sttimothy$finance$client$application$ApplicationPresenter$$_annotation$$none$$();
  }
  
  public javax.inject.Provider<org.sttimothy.finance.client.application.home.HomePagePresenter> getorgsttimothyfinanceclientapplicationhomeHomePagePresenter() {
    return fieldcom_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector.getFragment_org_sttimothy_finance_client_application_home().get_Key$type$com$google$inject$Provider$org$sttimothy$finance$client$application$home$HomePagePresenter$$_annotation$$none$$();
  }
